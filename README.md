...
| `scripts/check-claims.py` | the claim check: the phrases the page must not carry, each with its reason, the image tag it must carry, and the demo instance it must be telling the truth about |
